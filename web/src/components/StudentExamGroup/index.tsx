    ...
    return (
        <>
            ...
            <Box sx={{mb: 3, p: 2, backgroundColor: '#ffffff', borderRadius: '8px', border: '1px solid #0000ff'}}>
                <Typography variant={"h6"} fontWeight={600} color={'info'}>Tên bài
                    thi: {examGroupDetail?.name}</Typography>
                <Typography variant={"h6"} fontWeight={600} color={'error'}>Thời gian chờ giữa các đề
                    bài: {awaitTimeInMinutes} phút</Typography>
                <Typography variant={"h6"} fontWeight={600} color={'success'}>Trạng thái hoàn
...
function ExamsGrid({exams, classId, examGroupId, awaitingTime}: {
